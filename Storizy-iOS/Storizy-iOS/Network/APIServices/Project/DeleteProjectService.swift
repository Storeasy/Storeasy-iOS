...
struct DeleteProjectService {
    
    static let shared = DeleteProjectService()
    
    func deleteProject(accessToken: String, projectId: Int, completionHandler: @escaping (ResponseCode, Any) -> (Void)) {

        let url = APIUrls.delProjectURL + "\(projectId)"
