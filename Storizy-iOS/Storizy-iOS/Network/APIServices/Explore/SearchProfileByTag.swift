...
struct SearchProfileByTagService {
    static let shared = SearchProfileByTagService()
    
    func searchProfileByTag(accessToken: String, tagName: String, completionHandler: @escaping (ResponseCode, Any) -> (Void)) {

        let url = APIUrls.searchProfileURL
