...
struct ReadMyStoryService {
    static let shared = ReadMyStoryService()
    
    func getMyStory(accessToken: String, completionHandler: @escaping (ResponseCode, Any) -> (Void)) {

        let url = APIUrls.getMyStoryURL
