...
struct GetStoryTagsService {
    static let shared = GetStoryTagsService()
    
    func getStoryTags(accessToken: String, userId: Int, completionHandler: @escaping (ResponseCode, Any) -> (Void)) {

        let url = APIUrls.getStoryTagsURL + "\(userId)/tags"
        print("url\(url)")
